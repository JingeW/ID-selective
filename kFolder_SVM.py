'''SVM classification for full/ID/noID featureMatrix with 10-floder validation
    ...
    Mask: ID/nonID mask Generated by ANOVA

    output: dict of 10 floder acc
            avg acc plot
            barplot for acc mean and std of all layers
'''
import os
# import numpy as np
import datetime
...
# *********Adjustable***********
dataSet_name = 'CelebA_original_randDrop_0.3_conv1_1'
k = 5
sample_num = 10
class_num = 50
# ******************************
